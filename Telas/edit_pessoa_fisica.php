                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    ...
                                    <p class="card-category">Editar Pessoas Fisica</p>
                                </div>



                <form method="POST" name="form1" action="resp_edit_pessoa_fisica.php">
                    
                         <div class="col-md-12 fundo" align="left"> 
                        <div  class="form-group"><label for="company" class=" form-control-label">CPF</label><input type="text"  name="cpf" placeholder="Digite o cpf" class="form-control" value="<?php echo $dados['cpf']; ?>"></div>

                       </div>
                      <div class="col-md-12 fundo" align="left">
                        <div class="form-group"><label for="street" class=" form-control-label">Nome</label>
                           <input type="text"   name="nome"  placeholder="Digite o nome" class="form-control" value="<?php echo $dados['nome']; ?>"></div> 
                                 

                         <div class="col-md-12 fundo" align="left">
                        <div class="form-group"><label for="street" class=" form-control-label">Cidade</label><?php 
