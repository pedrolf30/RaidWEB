                    ...
                    <div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
                        <div class="panel panel-danger">
                            <div class="panel-body">
                                  <form method="POST" name="form1" action="resp_vCad.php">
        ...
        <input class="form-control" type="time" id="horario" name="horario"
               min="9:00" max="18:00" required />
                                     ...
                                     <div class="form-group">
                                       ...
                                       <?php 
                                       $sql  = mysqli_query($con, "SELECT nome FROM clientes ;" );?>
                               ...
                               <?php } 
                                    ?>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" name="preco" required class="form-control" placeholder="Digite o preço total">
                                    </div>
...
<h2>Success! Your Message was Sent Successfully.</h2>
 ...
 <a class="nav-link" href="Vendas.php" ">
  ...
  <a class="nav-link" href="vdCAD.php" >
                                        <button style="position: relative; bottom: 155px; left: 340px" class="btn btn-raised btn-lg btn-warning" >Adicionar Produtos</button>
                                    </a>
