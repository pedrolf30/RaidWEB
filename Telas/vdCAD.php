                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item">
                                <a class="nav-link" href="definir.php">
                                    <span class="no-ipcon">Definições</span>
                                </a>
                            </li>
                    ...
                    <div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
                        <div class="panel panel-danger">
                            <div class="panel-body">
                                  <form method="POST" name="form1" action="resp_vdCad.php">
                               ...
                               <?php } 
                                 ...
                                 <div class="form-group">
                                        ...
                                        <input type="text" name="quantidade" required class="form-control" placeholder="Digite a quantidade">
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" name="total" required class="form-control" placeholder="Digite o preço total">
                                    </div>
...
<h2>Success! Your Message was Sent Successfully.</h2>
 ...
 <a class="nav-link" href="vCad.php" ">
