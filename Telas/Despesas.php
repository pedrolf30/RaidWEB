                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    ...
                                    <p class="card-category">Despesas  Cadastradas</p>
                                </div>
...
$result = mysqli_query($link, "SELECT * FROM despesas");
    ...
    $total = $cont['total'];
        ...
        echo "<tr>
                ...
                <td><button><a href =\"edit_despesas.php?id=$id\">Editar</a></button></td>
                <td><button><a href =\"del_despesas.php?id=$id\">Deletar</a></button></td>
...
?>
                        ...
                        <div class="form-group">
                                <a class="nav-link" href="dCad.php">
