...
$result = mysqli_query($link, "SELECT * FROM fornecedor WHERE cnpj = $cnpj");
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500" >
                <div class=" container-fluid  " >
                    <a class="navbar-brand" href="#pablo"> Fornecedores </a>
                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    ...
                                    <p class="card-category">Editar Fornecedores</p>
                                </div>



                <form method="POST" name="form1" action="resp_edit_fornecedores.php">
                    
                                    <div class="form-group">
                                        <label >CNPJ/CPF</label>
                                        <input type="text" name="cnpj" required class="form-control" placeholder="Digite o CNPJ/CPF" value="<?php echo $dados['cnpj']; ?>">
                                    </div>
                                     <div class="form-group">
                                        <label >Razão Social / Nome</label>
                                        <input type="text" name="razao" required class="form-control" placeholder="Digite o nome ou razão social" value="<?php echo $dados['razao']; ?>">
                                    </div>
                                     <div class="form-group">
                                        <label >Cidade</label>
                                       <?php 
require ("conectbdvendas.php");
                               ...
                               <?php } 
                                    ?>
                                     ...
                                     <div class="form-group">
                                        <label >Email</label>
                                        <input type="email" name="email" required class="form-control" placeholder="Digite o email" value="<?php echo $dados['email']; ?>">
                                    </div>
                                     <div class="form-group">
                                        <label >Telefone</label>
                                        <input type="text" name="telefone" required class="form-control" placeholder="Digite o telefone" value="<?php echo $dados['telefone']; ?>">
                                    </div>
