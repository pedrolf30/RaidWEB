        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500" >
                <div class=" container-fluid  " >
                    <a class="navbar-brand" href="#pablo"> Cadastro Pessoa Juridica </a>
           ...
           <form method="POST" name="form1" action="resp_pjCad.php">
                    
                         <div class="col-md-12 fundo" align="left"> 
                        <div  class="form-group"><label for="company" class=" form-control-label">CNPJ</label><input type="text"  name="cnpj" placeholder="Digite o cnpj" class="form-control"></div>

                       </div>
                         <div class="col-md-12 fundo" align="left">
                        <div class="form-group"><label for="vat" class=" form-control-label">Razão social</label><input type="text" " name="razao" placeholder="Digite a razão social" class="form-control"></div>
                       </div>
                      ...
                      <div class="form-group"><label for="company" class=" form-control-label">Número</label><input type="text" name="numero" placeholder="Digite o número" class="form-control"></div>
                       <div class="form-group"><label for="company" class=" form-control-label">Telefone</label><input type="text" name="telefone" placeholder="Digite o telefone" class="form-control"></div>
                                     ...
                                     <div class="form-group">
                                        <button class="btn btn-raised btn-lg btn-warning" type="submit" name="incluir">Enviar</button>
                                    </div>
