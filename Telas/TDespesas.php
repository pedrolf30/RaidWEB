        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class=" container-fluid  ">
                    <a class="navbar-brand" href="#pablo"> Tipo de Depesas </a>
                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title">Tipos de Depesa</h4>
                                    <p class="card-category">Tipos de Depesa cadastradas</p>
                                </div>
...
$result = mysqli_query($link, "SELECT * FROM tipo_despesa");
    ...
    $tipo = $cont['tipo'];
        ...
        echo "<tr>
                ...
                <td><button><a href =\"edit_td.php?id=$id\">Editar</a></button></td>
                <td><button><a href =\"del_td.php?id=$id\">Deletar</a></button></td>
