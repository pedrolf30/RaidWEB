        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500" >
                <div class=" container-fluid  " >
                    <a class="navbar-brand" href="#pablo"> Cadastro Funcionarios </a>
                    ...
                    <div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
                        <div class="panel panel-danger">
                            <div class="panel-body">
                                <form method="POST" name="form1" action="resp_fCad.php">
                      <div class="col-md-12 fundo" align="left">
                        <div class="form-group"><label for="vat" class=" form-control-label">CPF</label><input type="text" " name="cpf" placeholder="Digite o cpf" class="form-control"></div>
                       </div>
                         <div class="col-md-12 fundo" align="left"> 
                        <div  class="form-group"><label for="company" class=" form-control-label">Nome</label><input type="text"  name="nome" placeholder="Digite o nome" class="form-control"></div>

                       </div>
                       

                         <div class="col-md-12 fundo" align="left">
                        <div class="form-group"><label for="street" class=" form-control-label">Salario</label><input type="text"  name="salario" placeholder="Digite o salario" class="form-control"></div>
                        <div class="row form-group">
                          ...
                          <div class="col-md-12 fundo" align="left">
                            <div class="form-group"><label for="postal-code" class=" form-control-label">Bairro</label><input type="text" placeholder="Digite o bairro"  name="bairro"  class="form-control"></div>
                          </div>
                        </div>
                        <div class="form-group"><label for="country" class=" form-control-label">Rua</label><input type="text"  placeholder="Digite a rua" name="rua" class="form-control"></div>

                      <div class="form-group"><label for="company" class=" form-control-label">CEP</label><input type="text" name="cep" placeholder="Digite o cep" class="form-control"></div>


                      <div class="form-group"><label for="company" class=" form-control-label">Número da Residencia</label><input type="text" name="numero" placeholder="Digite o numero" class="form-control"></div>
