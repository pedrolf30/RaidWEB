        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500" >
                <div class=" container-fluid  " >
                    <a class="navbar-brand" href="#pablo"> Cadastro Produtos </a>
                    ...
                    <div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
                        <div class="panel panel-danger">
                            <div class="panel-body">
                                    <form method="POST" name="form1" action="resp_pCad.php">
                    
                                    <div class="form-group">
                                        <label >Nome do Produto</label>
                                        <input type="text" name="nome" required class="form-control" placeholder="Digite o nome do produto">
                                    </div>
                                    <div class="form-group">
                                        <label >Preço do produto</label>
                                        <input type="text" name="preco" required class="form-control" placeholder="Digite o preço do produto">
                                    </div>
