...
$result = mysqli_query($link, "SELECT * FROM despesas WHERE id = $id");
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500" >
                <div class=" container-fluid  " >
                    <a class="navbar-brand" href="#pablo"> Despesas </a>
                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    ...
                                    <p class="card-category">Editar Despesas</p>
                                </div>



                 <form method="POST" name="form1" action="resp_edit_despesas.php">
                       <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label >Data</label>
                                       <input class="form-control"  type='date' name="data" value='<?php echo date("d/m/Y"); ?>' value="<?php echo $dados['data']; ?>">
                                    </div>
                                    <div class="form-group">
                               ...
                               <?php } 
                                    ?>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" name="descricao" required class="form-control" placeholder="Descrição da despesa" value="<?php echo $dados['descricao']; ?>">
                                    </div>
                                     <div class="form-group">
                                        <label >Valor da despesa</label>
                                        <input type="text" name="valor" required class="form-control" placeholder="Digite o valor da despesa" value="<?php echo $dados['valor']; ?>">
                                    </div>
                                     <div class="form-group">
                                        <label >Desconto</label>
                                        <input type="text" name="desconto" required class="form-control" placeholder="Digite o desconto" value="<?php echo $dados['desconto']; ?>">
                                    </div>
                                     <div class="form-group">
                                        <label >Valor final da despesa</label>
                                        <input type="text" name="total" required class="form-control" placeholder="Digite o valor final da despesa" value="<?php echo $dados['total']; ?>">
                                    </div>
