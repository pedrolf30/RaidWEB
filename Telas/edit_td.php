...
$result = mysqli_query($link, "SELECT * FROM tipo_despesa WHERE id = $id");
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500" >
                <div class=" container-fluid  " >
                    <a class="navbar-brand" href="#pablo"> Tipos de despesa </a>
                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title">Tipos de Despesa</h4>
                                    <p class="card-category">Editar Tipos de Despesa</p>
                                </div>



                 <form method="POST" name="form1" action="resp_edit_td.php">
                       <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input class="form-control"  type='text' name="tipo"  value="<?php echo $dados['tipo']; ?>">
                                    </div>
