        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500" >
                <div class=" container-fluid  " >
                    <a class="navbar-brand" href="#pablo"> Cadastro Fornecedores </a>
                    ...
                    <div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
                        <div class="panel panel-danger">
                            <div class="panel-body">
                                    <form method="POST" name="form1" action="resp_frnCad.php">
                    
                                    <div class="form-group">
                                        <label >CNPJ/CPF</label>
                                        <input type="text" name="cnpj" required class="form-control" placeholder="Digite o CNPJ/CPF">
                                    </div>
                                    <div class="form-group">
                                        <label >Razão Social/Nome</label>
                                        <input type="text" name="razao" required class="form-control" placeholder="Digite a Razão social / Nome">
                                    </div>
                                     <div class="form-group">
                                        <label >Cidade</label>
                                        <?php 
                               ...
                               <?php } 
                                    ?>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" name="telefone" required class="form-control" placeholder="Digite o telefone">
                                    </div>
