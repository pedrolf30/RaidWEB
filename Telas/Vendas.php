                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    ...
                                    <p class="card-category">Listagem de vendas  </p>
                                </div>
...
$result = mysqli_query($link, "SELECT * FROM vendas");

    while ($cont = mysqli_fetch_array($result)) {

    $id = $cont['id'];
    $data = $cont['data'];
    $horario = $cont['horario'];
    ...
    $preco = $cont['preco'];
        ...
        echo "<tr>
                ...
                <td><button><a href =\"detalhes_vendas.php?id=$id\">Detalhes</a></button></td>
                <td><button><a href =\"del_vendas.php?id=$id\">Deletar</a></button></td>
              </tr>";
