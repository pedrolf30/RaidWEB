                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    ...
                                    <p class="card-category">Funcionarios cadastrados</p>
                                </div>
...
$result = mysqli_query($link, "SELECT * FROM funcionarios");

    while ($cont = mysqli_fetch_array($result)) {

    $cpf = $cont['cpf'];
    $nome = $cont['nome'];
    $salario = $cont['salario'];
    $cidade = $cont['cidade'];
    $bairro = $cont['bairro'];
    $rua = $cont['rua'];
    $cep = $cont['cep'];
    ...
    $telefone = $cont['telefone'];
        echo "<tr>
                ...
                <td><button><a href =\"edit_funcionario.php?cpf=$cpf\">Editar</a></button></td>
                <td><button><a href =\"del_funcionarios.php?cpf=$cpf\">Deletar</a></button></td>
...
?>
                      ...
                      <div class="form-group">
                                <a class="nav-link" href="fCad.php">
