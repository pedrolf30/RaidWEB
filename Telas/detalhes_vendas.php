        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500" >
                <div class=" container-fluid  " >
                    <a class="navbar-brand" href="#pablo"> Vendas </a>
                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    ...
                                    <p class="card-category">Detalhes Venda</p>
                                </div>
...
$result = mysqli_query($link, "SELECT * FROM vendas_detalhes");

    while ($cont = mysqli_fetch_array($result)) {

    $ID = $cont['ID'];
    $produtos = $cont['produtos'];
    ...
    $total = $cont['total'];
        ...
        echo "<tr>
                ...
                <td><button><a href =\"del_detvendas.php?ID=$ID\">Deletar</a></button></td>
              </tr>";
...
?>
 ...
 the sea move when I say the word 
now I sleep alone on the streets I use to own  
        I use to rule the days 
see the the fear in my enemies's eyes
 -->
</body>
<!--   Core JS Files   -->
